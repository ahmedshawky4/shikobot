...
`.trimStart(),
  ...
  footer: '┗━━━━━━━━⬣\n',
  after: '*هذا البوت من تصميم و تطوير المهندس احمد شوقي عبد العال*\n+21027690419',
}
...
externalAdReply: {
title: 'SHIKO BOT♥',
body: "اول بوت واتساب في مصر",
thumbnailUrl: 'https://telegra.ph/file/29d245a2c42c065079a73.jpg',
sourceUrl: 'https://instagram.com/shiko._.masr',
mediaType: 1,
renderLargerThumbnail: true
}}}, { quoted: m})

    /*conn.sendFile(m.chat, 'menu.png', text.trim(), m, null, )
    /*conn.sendButton(m.chat, text.trim(), '▢ SHIKO  ┃ ᴮᴼᵀ\n▢ Sígueme en Instagram\nhttps://www.instagram.com/shiko._.masr', pp, [
      ['ꨄ︎ Apoyar', `${_p}donate`],
      ['⏍ Info', `${_p}botinfo`],
      ['⌬ Grupos', `${_p}gpdylux`]
    ],m, rpl)*/
